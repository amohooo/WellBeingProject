...
public class DataBaseConnection {
    ...
    private static final String INITIAL_DATABASE_URL = "jdbc:mysql://127.0.0.1:3306/" + "?serverTimezone=Australia/Sydney";

    // This is your connection URL after the database is created
    private static final String DATABASE_URL = "jdbc:mysql://127.0.0.1:3306/" + DATABASE_NAME + "?serverTimezone=Australia/Sydney";
    public Connection databaseLink;

    public void createDatabase() {
        try (Connection conn = DriverManager.getConnection(INITIAL_DATABASE_URL, DATABASE_USER, DATABASE_PASSWORD);
